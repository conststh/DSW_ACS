...
public final class DirectoryDoors
{
  ...
  public static void makeDoors()
  {
    ...
    // Recuperar las nuevas escaleras por planta
    Space stairsBasement = (Space) DirectoryAreas.findAreaById("stairs basement");
    Space stairsGround = (Space) DirectoryAreas.findAreaById("stairs ground");
    Space stairsFloor1 = (Space) DirectoryAreas.findAreaById("stairs floor 1");

    // Crear Puertas con IDs y conexiones actualizadas
    Door d1 = new Door("D1", exterior, parking);
    Door d2 = new Door("D2", stairsBasement, parking);
    Door d3 = new Door("D3", exterior, hall);
    Door d4 = new Door("D4", hall, stairsGround);
    Door d5 = new Door("D5", hall, room1);
    Door d6 = new Door("D6", hall, room2);
    Door d7 = new Door("D7", corridor, stairsFloor1);
    ...
    // Establecer enlace bidireccional
    exterior.addDoor(d1);       parking.addDoor(d1);
    stairsBasement.addDoor(d2); parking.addDoor(d2);
    exterior.addDoor(d3);       hall.addDoor(d3);
    hall.addDoor(d4);           stairsGround.addDoor(d4);
    hall.addDoor(d5);           room1.addDoor(d5);
    hall.addDoor(d6);           room2.addDoor(d6);
    corridor.addDoor(d7);       stairsFloor1.addDoor(d7);
